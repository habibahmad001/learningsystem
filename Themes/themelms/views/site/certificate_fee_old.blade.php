...
<?php
                            ...
                            $fee_amount=19.99;
                        ?>
                        <form class="studentId_form new__formStyle" name="std_frm" id="std_frm" method="post" enctype="multipart/form-data" action="{!! URL::to("/addmoney/paypalprocertificate") !!}">
                            ...
                            <div class="row basicInfo">
                                ...
                                <div class="form-content">
                                    <div class="form-group col-md-12">
                                        <div class="form-row">
                                            <label class="col-md-6 labels">Courses Certificate - Free </label>
                                        </div>
                                    </div>
                                    <div class="form-group col-md-12">
                                    ...
                                    <div class="form-group col-md-12">
                                        <label>Total Fee <b id="card_price">{{getSetting('currency_code','site_settings')}} 19.99</b></label>
                                    </div>
                            ...
                            <div class="form-content">
                                ...
                                <div class="row shipInfo" style="display: none;">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="field">
                                            <input type="number" name="std_zipcode"  required="required" id="std_zipcode" placeholder="Zip Code">
                                ...
                                <div class="row billInfo" style="display: none;">
                                    ...
                                    <div class="form-group text-center col-md-12" id="paynow_btn" >
                                        {{--<input type="submit" id="placeorder" class="btn btn-primary theme-btn btn-block" value="Place Order" >--}}
                                    ...
                                    $productDesc = "Printed Certificate Fee";
                                    $currency = "GBP";
                                    $productPrice = $fee_amount;
                                    $productId = $course_id;
                                    $orderNumber = $course_id.'-'.$user_id;

                                    $recp_name = $user_name;
                                    $line_1= "57, Nargis Block ";
                                    $line_2= "Allama Iqbal Town";
                                    $city="Lahore";
                                    $zip="54570";
                                    $phone=$user_phone;
        ...
        $(document).ready(function() {
            ...
            $('input[name="paymentMethod"]').change(function() {
                if ($(':radio[id=paypalpro]').is(':checked')){
                    $("#std_frm").attr("action", "{!! URL::to('/addmoney/paypalprocertificate') !!}");
