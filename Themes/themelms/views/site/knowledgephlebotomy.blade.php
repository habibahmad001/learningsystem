        ...
        <div class="container">
            <div class="row align-items-center justify-content-center">
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 text-white">
                    ...
                    <p>If you wish to specialise in phlebotomy, here’s a training that will prepare you successfully to embark on a career as a phlebotomist.</p>
                ...
                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12 position-relative text-center">
                    ...
                    <div class="video_section">
                        ...
                        <img src="https://infinity-bucket-2020.s3.eu-west-2.amazonaws.com/images/video_img.png" class="img-fluid">
                    </div>
        ...
        <div class="container">
            <div class="row row align-items-lg-center justify-content-center">
                <div class="col-md-6 col-sm-12 col-xs-12 text-center position-relative">
                    <img class="img-fluid" src="https://infinity-bucket-2020.s3.eu-west-2.amazonaws.com/images/about_img1.png"/>
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 mt-20">
                    ...
                    <p>Individuals Working In The Healthcare Sector Nursing Staff, Medical Assistants, Lab Technicians</p>
                    <ul class="course-list">
                        <li><i class="fa fa-check"></i>The characteristics and traits to enter this field.</li>
                        <li><i class="fa fa-check"></i>How to meet the challenges of complications on a daily basis.</li>
                        <li><i class="fa fa-check"></i>An understanding of the components of blood.</li>
                        <li><i class="fa fa-check"></i>Learning to examine venipuncture equipment.</li>
                    </ul>
        ...
        <div class="container">
            <div class="row row align-items-center justify-content-center">
                <div class="col-md-6 col-sm-12 col-xs-12">
                    <h2 class="main-title">Benefits of our Phlebotomy Course</h2>
                    <ul class="course-list">
                        ...
                        <li><i class="fa fa-check"></i>Number of Modules: 9</li>
                        <li><i class="fa fa-check"></i>Guided Learning Hours: 2</li>
...
{{--                    <a href="{!! url("/redeem_a_voucher?coursenamepost=" . $lms_series->title) !!}" class="btn btn-secondary">Redeem a Voucher</a>--}}
                ...
                <div class="col-md-6 col-sm-12 col-xs-12 text-center mt-20">
                    <img class="img-fluid" src="https://infinity-bucket-2020.s3.eu-west-2.amazonaws.com/images/about_img2.png"/>
                </div>
            </div>
        </div>
    </section>
...
{{--    <section>--}}
{{--        <div class="container">--}}
{{--            <div class="fellow-creators text-center bg-white">--}}
{{--                <p class="sub-title">A home for your business</p>--}}
{{--                <h2 class="main-title">Join your fellow creators</h2>--}}
{{--                <p class="title-text">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam</p>--}}
{{--                <a class="btn btn-secondary rounded-pill" href="{!! url("/redeem_a_voucher?coursenamepost=" . $lms_series->title) !!}">Redeem a Voucher</a>--}}
{{--            </div>--}}
{{--        </div>--}}
{{--    </section>--}}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <video width="100%" height="100%" poster="https://dgzyo31xc1vmh.cloudfront.net/lms/series/widget/1032-image.jpg" controls="">
                        <source src="https://dgzyo31xc1vmh.cloudfront.net/lms/series/videos/1648465310-video.mp4" type="video/mp4">
                    </video>
                </div>
            </div>
        </div>
