...
<?php
                            ...
                            $fee_amount=4.99;
                        ?>
                        <form class="studentId_form new__formStyle form_with_payment" name="std_frm" id="std_frm" method="post" enctype="multipart/form-data" action="{!! URL::to("/addmoney/paypalpro") !!}">
                            ...
                            <div class="row basicInfo">
                                ...
                                <div class="form-content">
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio" data-price="{{currencyPrice('4.99')}}" checked>(United Kingdom and Ireland Only) - {!! formatPrice(4.99,0, false) !!}
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio" data-price="{{currencyPrice('9.99')}}">(Excluding African & Middle Eastern Countries) - {!! formatPrice(9.99,0, false) !!}
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        ...
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio" data-price="{{currencyPrice('45.00')}}">(All Countries) - {!! formatPrice(45.00,0, false) !!}
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>
                                        {{--<label class="labels">Test Courier <span>*</span></label>
                                        <div class="form-check">
                                            <label class="form-check-label">
                                                <input type="radio" class="form-check-input" name="optradio" data-price="1.00">(All Countries) - {{getSetting('currency_code','site_settings')}} 1.00
                                                <span class="checkmark"></span>
                                            </label>
                                        </div>--}}
                                    </div>
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="field">
                                            <input type="text" name="user_name"  required="required" id="user_name" value="" placeholder="User Name">
                            ...
                            <div class="form-content">
                                ...
                                <div class="row shipInfo" style="display: none;">
                                    ...
                                    <div class="form-group col-md-6">
                                        <div class="field">
                                            <input type="text" name="std_zipcode"  required="required" maxlength="10" id="std_zipcode" placeholder="Zip Code">
                                ...
                                <div class="spacer-div"></div>
                                <input type="hidden" type='text' value="{{currencyPrice($fee_amount)}}" name="order_amount">
                                <input type="hidden" type='text' value="12" name="user_id">
                                <input type="hidden" type='text' value="999" name="course_id">
                                <input type="hidden" name="gateway" id="gateway" value="paypalpro">
                                <input type="hidden" name="type" ng-model="item_type" value="reed-certificate">
                                ...
                                <input type="hidden" name="actual_cost" id="actual_cost" value="{{currencyPrice($fee_amount)}}">
                                <input type="hidden" name="discount_availed" id="discount_availed" value="0">
                                <input type="hidden" name="after_discount" id="after_discount" value="{{currencyPrice($fee_amount)}}">
                                <input type="hidden" name="course_type" id="course_type" value="reed">
