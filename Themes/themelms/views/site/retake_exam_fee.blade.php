...
@section('content')
    <div class="main-content inner_pages">
        <section class="corporate_section retake__feeBanner" style="background-image:url('<?=UPLOADS.'images/header_bg/certificate_fee.jpg'?>');">
            <div class="container">
                <div class="row">
...
<?php
                            ...
                            $fee_amount=5;
                        ?>
                        <form class="studentId_form new__formStyle form_with_payment" name="std_frm" id="std_frm" method="post" enctype="multipart/form-data" action="{!! URL::to("/addmoney/paypalpro") !!}" onsubmit="return validate_student('');">
                            ...
                            <div class="form-content">
                                ...
                                <div class="row billInfo" style="display: none;">
                                    ...
                                    <div class="payment-method">
                                        <div class="radio">
                                            <label>
                                                <input type="radio" name="paymentmethod" id="paypalcheckout" value="option2">PayPal Checkout Smart
                                                <img class="" src="{{UPLOADS.'images/paypal.jpg'}}">
                                            </label>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('input[name="paymentmethod"]').change(function() {
                if ($(':radio[id=paypalcheckout]').is(':checked')){
                    $("#gateway").val('paypalcheckout');
