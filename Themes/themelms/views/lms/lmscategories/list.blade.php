						...
						<table id="table" class="table table-striped table-bordered datatable r_s_h" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th>{{ getPhrase('Sub Categories')}}</th>
									<th>{{ getPhrase('image')}}</th>
									<th>{{ getPhrase('icon')}}</th>
...
$arr = array(
    ...
    array( "data" => "subcategories", "name" => "subcategories" ),
    array( "data" => "image", "name" => "image"),
    array( "data" => "icon", "name" => "icon" ),
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('colnames'=>$colnames,'route'=>'lmscategories.dataTable'))
