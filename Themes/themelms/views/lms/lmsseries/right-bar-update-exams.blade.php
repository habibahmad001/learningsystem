<div class="panel-heading">
	...
	{!! Form::open(array('url' => URL_LMS_SERIES_UPDATE_EXAMS.$record->slug, 'method' => 'POST')) !!}
			...
			<div class="col-md-12 clearfix">
				<div ng-if="savedSeries!=''" class="vertical-scroll" >
								  ...
								  <tr>
									...
									<th>{{getPhrase('course_section')}}</th>
									<th></th>	
									</tr>
									</thead>
									<tbody>
										...
										<td>@{{ savedSeries[$index].exam_type  }}</td>
										<td>@{{ savedSeries[$index].section_id}}</td>
