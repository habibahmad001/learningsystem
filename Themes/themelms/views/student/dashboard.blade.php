...
<div class="row">
	...
	<div class="col-md-4 col-sm-6">
		<div class="media state-media box-ws">
			<div class="media-left">
				<a href="{{URL_FEEDBACK_SEND}}"><div class="state-icn bg-icon-blue"><i class="fa fa-heart"></i></div></a>
			</div>
			<div class="media-body">
...
<!-- /#page-wrapper -->
<div class="modal fade in sharewithfriends" id="sharewithfriends" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
	<div class="modal-dialog " role="document">
		<div class="modal-content ">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
				<h4 class="modal-title" id="shareit">Share with Friends</h4>
			</div>
			<div class="modal-body">
				<div class="sharethis-inline-share-buttons"></div>
				<script type='text/javascript' src='https://platform-api.sharethis.com/js/sharethis.js#property=5d18ee375d452b00127d7674&product=inline-share-buttons' async='async'></script>
