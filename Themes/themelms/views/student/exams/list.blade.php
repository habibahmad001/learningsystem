...
@if($interested_categories)
  @if($category)
	 @include('common.datatables', array('colnames'=>$colnames,'route'=>URL_STUDENT_QUIZ_GETLIST.$category->slug, 'route_as_url' => TRUE))
  @else
	 @include('common.datatables', array('colnames'=>$colnames,'route'=>URL_STUDENT_QUIZ_GETLIST_ALL, 'route_as_url' => TRUE))
  @endif
