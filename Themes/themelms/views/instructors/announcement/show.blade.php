                ...
                @else
                  <div class="col-md-3">
                    ...
                    <select class="form-control" id="status" name="status">
                      <option value="1" {{ $announs->status==1 ? 'selected' : '' }}>Approved</option>
                      <option value="0" {{ $announs->status==0 ? 'selected' : '' }}>Not Approved</option>
                      <option value="2" {{ $announs->status==2 ? 'selected' : '' }}>Pending</option></select>
