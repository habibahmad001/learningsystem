				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							<a href="{{URL_PROMOPOPUP_ADD}}" class="btn btn-primary button" >{{ getPhrase('create')}}</a>
						</div>
...
$arr = array(
	...
	array( "data" => "display_on", "name" => "display_on"),
...
@section('footer_scripts')
	 ...
	 @include('common.datatables', array('colnames'=>$colnames,'route'=>URL_PROMOPOPUP_GETLIST, 'route_as_url' => TRUE))
 	 @include('common.deletescript', array('route'=>URL_PROMOPOPUP_DELETE))
