...
$arr = array(
    ...
    array( "data" => "valid_from", "name" => "valid_from"),
    array( "data" => "valid_to", "name" => "valid_to"),
    array( "data" => "url", "name" => "url"),
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('colnames'=>$colnames,'route'=>URL_ADMIN_NOTIFICATIONS_GETLIST, 'route_as_url' => TRUE))
