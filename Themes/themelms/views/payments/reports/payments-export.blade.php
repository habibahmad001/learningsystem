...
<div id="page-wrapper" ng-controller="payments_report" ng-init="initAngData()">
 ...
 <h1>{{ $title }} </h1>
					...
					<div class="panel-body paymentExport__form">
					<?php $button_name = getPhrase('download_report');
if($record){
    ?>
						<div class="row">
							<div class="buttons text-center">
								<a href="{{$reporturl}}" class="btn btn-lg btn-success button">{{ $button_name }}</a>
								<a href="{{url('payments-report/export')}}" class="btn btn-lg btn-primary button">Create New Report</a>
							</div>
						</div>
