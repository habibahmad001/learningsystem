				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							...
							<a href="{{URL_POST_CATEGORY_ADD}}" class="btn  btn-primary button" >{{ getPhrase('create')}}</a>
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('colnames'=>$colnames,'route'=>'postcategories.dataTable'))
 @include('common.deletescript', array('route'=>URL_POST_CATEGORY_DELETE))
