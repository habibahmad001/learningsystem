				...
				<div class="row" id="imgdiv">
					...
					<fieldset class="form-group">
						...
						<label for="img">Mobile Image</label>

						<input type="file" name="mobimg" id="mobimg" />
						<p style="color: red; font-size: 11px; padding: 2% 0;">Mobile banner size must be 400X280</p>
						<img src="{!! (isset($record->mobavatar)) ? UPLOADS.'lms/series/offerbanner/'.$record->mobavatar : "https://via.placeholder.com/400x280" !!}" width="400" height="280" style="border-radius: 8px;" />
					...
					<fieldset class="form-group">
						<label for="showall">Show courses without category</label>
						<select class="form-control" id="showall" name="showall">
							<option value="no">Show courses without category</option>
							<option value="yes" {!! (isset($record->showall) && $record->showall == "yes") ? "selected" : "" !!}>Yes</option>
							<option value="no" {!! (isset($record->showall) && $record->showall == "no") ? "selected" : "" !!}>No</option>
						</select>
					</fieldset>
