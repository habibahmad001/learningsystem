				...
				<div class="row">
				   ...
				   {{ Form::label('image', getphrase('image')) }}
                    ...
                    <?php
                    $options_exams = array('Mock'=> getPhrase('Mock'), 'Final'=> getPhrase('final'), 'Assignment'=> getPhrase('assignment'), 'Quiz'=> getPhrase('quiz'));
                    ?>
					...
					<fieldset class="form-group col-md-3">
						...
						<span class="text-red">*</span>
						{{Form::select('exam_type', $options_exams, null, ['class'=>'form-control','ng-model'=>'exam_type'])}}
