 					 ...
 					 <fieldset class="form-group">
 					  ...
 					  <fieldset class="form-group" >
				   {{ Form::label('category', getphrase('image')) }} <span class="badge badge-success"> Size:2MB, Allowed Ext: .png, .jpg, .jpeg</span>
					...
					@if($record)
				         ...
				         <img src="{{ IMAGE_PATH_UPLOAD_QUIZ_CATEGORIES.$record->image }}" height="100" width="100" >
