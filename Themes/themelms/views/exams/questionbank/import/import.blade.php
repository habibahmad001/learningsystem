...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="panel panel-custom col-lg-6 col-lg-offset-3">
					...
					<a href="{{DOWNLOAD_LINK_QUESTION_IMPORT_EXCEL}}subject_radio_template.xlsx" class="btn btn-info">{{getPhrase('single_subject')}}
					</a>
					<a href="{{DOWNLOAD_LINK_QUESTION_IMPORT_EXCEL}}subject_radio_template.xlsx" class="btn btn-info">{{getPhrase('multi_subject')}}
					</a>
					...
					$question_types 		= array( ''              => 'Select',
                                        'radio'         => 'Single Subject',
                                        'checkbox'      => 'Multi Subject',
                                        'blanks'        => 'Fill in blanks');

					?>
					 	<div class="row">
						<fieldset class='col-sm-4 col-sm-offset-4 form-group margintop30'>
						{{ Form::label('subject_type', getphrase('subject_type')) }}
