				...
				<div class="panel panel-custom col-lg-8 col-lg-offset-2">
					...
					@if ($record)
					 <?php $button_name = getPhrase('update'); ?>
						{{ Form::model($record, 
						array('url' => URL_MARKETTINGBANNER_ADD.$record->slug,
						'method'=>'patch', 'name'=>'formMarketting', 'novalidate'=>'')) }}
					@else
						{!! Form::open(array('url' => URL_MARKETTINGBANNER_ADD, 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'frmmark', 'name'=>'frmmark', 'novalidate'=>'')) !!}
					@endif
					

					 @include('marketingbanner.form_elements',
