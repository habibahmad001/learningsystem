				...
				<div class="panel panel-custom">
					<div class="panel-heading">
						...
						<div class="pull-right messages-buttons">
							<a href="{{URL_FAQ_QUESTIONS_ADD}}" class="btn  btn-primary button" >{{ getPhrase('create')}}</a>
						</div>
					...
					<div class="panel-body packages">
						...
						<table  id="table"  class="table table-striped table-bordered datatable r_s_h" cellspacing="0" width="100%">
							<thead>
								<tr>
									<th> All <input type="checkbox" class='checkall' id='checkall'><input class="btn btn-sm btn-primary"  type="button" data-id="{{ route('faq-questions.massremove')}}" id='delete_record' value='Delete' ></th>
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('route'=>URL_FAQ_QUESTIONS_GETLIST, 'route_as_url' => TRUE))
