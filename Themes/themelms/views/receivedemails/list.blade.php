...
$arr = array(
    ...
    array( "data" => "telephone_no", "name" => "std_tel"),
...
@section('footer_scripts')
	 ...
	 @include('common.datatables', array('colnames'=>$colnames,'route'=>URL_STUDENT_ID_GETLIST, 'route_as_url' => TRUE))
 	 @include('common.deletescript', array('route'=>URL_STUDENT_ID_EDIT))
