...
<div id="page-wrapper">
			<div class="container-fluid">
				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><a href="{{URL_CORPORATE}}">{{ getPhrase('corporate_emails')}}</a></li>
							<li class="active">{{isset($title) ? "View" : ''}}</li>
						</ol>
					</div>
				</div>
				...
				<div class="panel panel-custom col-lg-8 col-lg-offset-2">
					...
					<?php $button_name = getPhrase('view'); ?>
					@if ($record)
					 <?php $button_name = getPhrase('update'); ?>
						 {!! Form::open(array('url' => URL_CORPORATE_EDIT . collect(request()->segments())->last(), 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'frmmark', 'name'=>'frmmark', 'novalidate'=>'')) !!}
					@else
						{!! Form::open(array('url' => URL_CORPORATE_EDIT, 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'frmmark', 'name'=>'frmmark', 'novalidate'=>'')) !!}
					@endif
					
					 @if($active_class == "Corporate")
						 @include('receivedemails.form_corporate',
						 array('button_name'=> $button_name),
						 array('record'=> $record))
					 @else
						@include('receivedemails.form_elements',
                        array('button_name'=> $button_name),
                        array('record'=> $record))
					 @endif
