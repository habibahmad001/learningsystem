						...
						<table id="table" class="table table-striped table-bordered datatable r_s_h" cellspacing="0" width="100%">
							<thead>
								<tr>
									...
									<th> All <input type="checkbox" class='checkall' id='checkall'><input type="button" class="btn btn-sm btn-primary"  data-id="{{ route('mastsubjects.massremove')}}" id='delete_record' value='Delete' ></th>
									<th>{{ getPhrase('id')}}</th>
...
@section('footer_scripts')
 ...
 @include('common.datatables', array('colnames'=>$colnames,'route'=>'subjects.dataTable'))
