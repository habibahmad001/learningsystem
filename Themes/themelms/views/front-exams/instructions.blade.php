			...
			<div class="panel-body instruction no-arrow">
				<div class="w-100">
						...
						@if($instruction_data=='')
								...
								{!! $instruction_data !!}
								@endif
						<ul class="guide newGuide">
							<li><span class="answer"><i class="mdi mdi-check"></i></span> You have answered the question.</li>
							<li><span class="notanswer"><i class="mdi mdi-close"></i></span> You have not answered the question.</li>
							<li><span class="marked"><i class="mdi mdi-eye"></i></span> You have answered the question but have marked the question for review.</li>
							<li><span class="notvisited"><i class="mdi mdi-eye-off"></i></span> You have not visited the question yet.</li>
						</ul>

				</div>

					
						<div class="form-group mt-30 trem_checkBTN">
						{!! Form::open(array('url' => 'frontend/start-exam/'.$record->slug, 'method' => 'POST')) !!}


								<input type="checkbox" name="option" id="free" ng-model="agreeTerms">
