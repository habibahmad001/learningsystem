				...
				<div class="row">
					<div class="col-lg-12">
						<ol class="breadcrumb">
							...
							<li><a href="{{URL_CERTIFICATES}}">{{ getPhrase('marketing')}}</a></li>
				...
				<div class="panel panel-custom col-lg-8 col-lg-offset-2">
					...
					@if ($record)
					 <?php $button_name = getPhrase('update'); ?>
						 {!! Form::open(array('url' => URL_ENQUIRIES_VIEW . collect(request()->segments())->last(), 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'frmmark', 'name'=>'frmmark', 'novalidate'=>'')) !!}
					@else
						{!! Form::open(array('url' => URL_ENQUIRIES_VIEW, 'method' => 'POST', 'enctype' => 'multipart/form-data', 'id'=>'frmmark', 'name'=>'frmmark', 'novalidate'=>'')) !!}
					@endif
					

					 @include('enquires.form_elements',
