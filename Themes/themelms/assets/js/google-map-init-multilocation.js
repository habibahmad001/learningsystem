function initialize() {
    ...
    // Multiple Markers
    var markers = [
        ['14 New Street, London, United Kingdom, EC2M 4HE',51.5174005,-0.0823304]
    ];
                        
    // Info Window Content
    var infoWindowContent = [
        ['<div class="info_content">' +
        '<h3 style="margin-top: 0px">Infinty Learning</h3>' +
        '<p>14 New Street, London, United Kingdom, EC2M 4HE.</p><p> Phone: 0208 126 9090</p> <p>Email:info@nextlearnacademy.com</p>' +        '</div>'],
