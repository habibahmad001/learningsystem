    ...
    public function getDatatable()
    {
      if(!checkRole(getUserGrade(2)))
      {
        ...
        return Datatables::of($records)
            ...
            ->rawColumns(['title','action','check_course'])
...
//        $record->slug 			        = str_slug($name);
    ...
    public function deleteMultipleMastSubjects(Request $request)
    {
        ...
        $records = Subject::whereIn('id', $id_array);
       // $record = Subject::where('slug', $slug)->first();
        /**
         * Check if any topic exists in this subject
         * If topics are available, dont delete this subject
