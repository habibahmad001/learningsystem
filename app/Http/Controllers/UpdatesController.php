    ...
    public function updateDatabase()
    {
      ...
      DB::statement($query);
        ...
        $query = "INSERT INTO `themes` (`id`, `title`, `slug`, `theme_title_key`, `settings_data`, `description`, `is_active`, `created_at`, `updated_at`) VALUES
            ...
            (2, 'Theme One', 'theme_one', 'themeone', NULL, NULL, 0, '2018-03-24 00:00:00', '2018-04-02 04:35:59'),
            (3, 'Theme LMS', 'theme_lms', 'themelms', NULL, NULL, 1, '2018-03-24 00:00:00', '2018-04-02 04:35:59')";
          ...
          $themelms = App\SiteTheme::where('theme_title_key','=','themelms')->first();
          if($themelms){
              $themelms->settings_data = '{
                      "home_page_title": {
                        "value": "Theme LMS",
                        "type": "text",
                        "extra": "",
