         ...
         if ($request->hasFile($sfname)) {
          ...
          $ext = pathinfo($path, PATHINFO_EXTENSION);
              ...
              if(env('FILESYSTEM_DRIVER')=='s3'){
                  $image_normal = Image::make($request->file('image'));
//                  $image_normal = Image::make($file['value']->getRealPath());
                  uploadToS3($image_normal,'settings/',$fileName);
