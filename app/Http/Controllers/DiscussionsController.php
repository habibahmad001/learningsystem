...
class DiscussionsController extends Controller
{
    ...
    public function index()
    {
        ...
        $data['title'] = getPhrase('discussions');
        $data['layout'] = getLayout();

        $view_name = getTheme() . '::discussions.list';
    ...
    public function getDatatable()
    {
        ...
        $records = App\DiscussionQuestion::select(['id','question' ,'reviews.comment','reviews.review_title as  review_title','approved', 'users.name as username','reviews.rating','reviews.updated_at'])
