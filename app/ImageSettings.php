...
class ImageSettings extends Model
{
    ...
    protected $cardPhotoPath      = UPLOADS."users/cards/";
    protected $cardPhotoPathThumb = UPLOADS."users/cards/thumbnail/";

    protected $instructorPath      = UPLOADS."instructors/";
    protected $instructorThumbPath      = UPLOADS."instructors/thumbnail/";
    protected $thumbnailSize = 50;
    protected $userthumbnailSize = 70;
    protected $widgetSize = 350;
	...
	protected $settingsImagePath = UPLOADS_LOCAL."settings/";
    ...
    protected $blogThumbnailSize    = 450;
    ...
    {
        return $this->defaultBlogImgPath;
    }
    ...
    {
        return $this->defaultBlogImgThumbnailpath;
    }


    public function getBlogImgPath()
    {
        return $this->blogImgPath;
    }
    ...
    {
        return $this->blogImgThumbnailpath;
    }
    ...
    public function setInstructorPicsPath($path)
    {
        $this->instructorPath = $path;
    }
    public function getInstructorPicsPath()
    {
       return $this->instructorPath;
    }

    public function getInstructorPicsThumbPath()
    {
        return $this->instructorThumbPath;
    }
    /**
     * Returns the Profile Pics Path
     * @return [string] [description]
     ...
     * @return [string] [description]
     */
    public function getCardPhotoPath()
    {
     ...
     * @return [string] [description]
     */
    public function getCardPhotoPathThumb()
    {
        return $this->cardPhotoPathThumb;
    }
    ...
    public function getUserThumbnailSize()
    {
